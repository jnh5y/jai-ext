...
/**
 * This test-class extends the TestScale class and is used for testing the bicubic interpolation inside the Scale operation. The first method tests
 * the scale operation without the presence of a ROI or a No Data Range. The 2nd method introduces a ROI object calculated using a ROI RasterAccessor
...
public class BicubicScaleTest extends TestScale2 {
    ...
    public void testImageScaling() {
        ...
        testGlobal(useROIAccessor, isBinary, bicubic2DIsabled, noDataRangeUsed, roiPresent,
                InterpolationType.BICUBIC_INTERP, TestSelection.NO_ROI_ONLY_DATA,
                ScaleType.MAGNIFY);
    ...
    public void testImageScalingROIAccessor() {
        ...
        testGlobal(useROIAccessor, isBinary, bicubic2DIsabled, noDataRangeUsed, roiPresent,
                InterpolationType.BICUBIC_INTERP, TestSelection.ROI_ACCESSOR_ONLY_DATA,
                ScaleType.MAGNIFY);
    ...
    public void testImageScalingROIBounds() {
        ...
        testGlobal(useROIAccessor, isBinary, bicubic2DIsabled, noDataRangeUsed, roiPresent,
                InterpolationType.BICUBIC_INTERP, TestSelection.ROI_ONLY_DATA, ScaleType.MAGNIFY);

        testGlobal(useROIAccessor, isBinary, bicubic2DIsabled, noDataRangeUsed, roiPresent,
                InterpolationType.BICUBIC_INTERP, TestSelection.ROI_ONLY_DATA, ScaleType.REDUCTION);
    }
    ...
    public void testImageScalingTotal() {
        ...
        testGlobal(useROIAccessor, isBinary, bicubic2DIsabled, noDataRangeUsed, roiPresent,
                InterpolationType.BICUBIC_INTERP, TestSelection.ROI_ACCESSOR_NO_DATA,
                ScaleType.MAGNIFY);
    ...
    public void testImageScalingBinary() {
        ...
        testGlobal(useROIAccessor, isBinary, bicubic2DIsabled, noDataRangeUsed, roiPresent,
                InterpolationType.BICUBIC_INTERP, TestSelection.BINARY_ROI_ACCESSOR_NO_DATA,
                ScaleType.MAGNIFY);
