...
public class TestScale2 extends TestBase {
    ...
    protected <T extends Number & Comparable<? super T>> void testImage(int dataType,
        ...
        // Scale operation
        RenderedImage destinationIMG = Scale2Descriptor.create(sourceImage, scaleXd, scaleYd,
                transXd, transYd, interp, roi, useROIAccessor, noDataRange, bkg, hints);
    ...
    protected void assertInterpolateInHole(int dataType, Interpolation interpolation) {
        ...
        int width = 10;
        int height = 10;
        TiledImage source = new TiledImage(0, 0, 10, 10, 0, 0, sm,
        ...
        RenderingHints hints = new RenderingHints(JAI.KEY_BORDER_EXTENDER,
                BorderExtender.createInstance(BorderExtender.BORDER_COPY));
        RenderedImage scaled = Scale2Descriptor.create(source, 2d, 2d, 0d, 0d, interpolation, null,
                null, RangeFactory.create(0, 0), null, hints);
