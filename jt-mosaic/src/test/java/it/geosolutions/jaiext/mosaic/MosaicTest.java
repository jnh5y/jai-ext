...
public class MosaicTest extends TestBase {
	...
	private final static MosaicType DEFAULT_MOSAIC_TYPE = MOSAIC_TYPE_OVERLAY;
    ...
    private void testAlphaMask(
        ...
        PlanarImage image =
                TranslateDescriptor.create(combined, 112f, 0F, null, null);
        ...
        final RenderedOp mosaic =
                MosaicDescriptor.create(
                        new PlanarImage[] {image},
                        mosaicType,
                        new PlanarImage[] {alpha},
                        null,
                        null,
                        null,
                        null,
...
//		RenderedImageBrowser.showChain(alpha);
    ...
    public static <T extends Number> PlanarImage getConstantImage(
            int dataType, T[] values, float width, float height) {
        ParameterBlock pb = new ParameterBlock();
        pb.add(width);
        pb.add(height);
        pb.add(values);
